...
class mainframe(Frame):
    ...
    #Create table for students
        ...
        if result:
            ...
            pass
             ...
             # there are no tables
            mycursor.execute("CREATE TABLE student(id CHAR(10) NOT NULL,name VARCHAR(100) NOT NULL, course_code CHAR(10) NOT NULL, year CHAR(10) NOT NULL, gender CHAR(10) NOT NULL , PRIMARY KEY (id))")
            print('no tables')
        mysqldb.close()
    ...
    #Options
        ...
        Button(self.btn_frame, text='Add Course', font = "Segoe 13", relief = GROOVE, bd = 0, command = self.add_course, fg ='black', height= 1, bg= 'Gold').grid(row = 0, column = 3,pady =7,padx =7,sticky="W")
    ...
    def main(self):
        ...
        if self.option == 1:
            Button(self.stud_form, text="Save", font="Segoe 11", relief=GROOVE, bd=0, command=self.save_sql, fg="black", bg="gold",height = 1, width = 5).grid(row=7, column = 1, pady =7,padx =2, sticky = 'e')      
        ...
        if self.option == 2:
            Button(self.stud_form, text="Update", font="Segoe 11", relief=GROOVE, bd=0, command=self.update, fg="black", bg="gold",height = 1, width = 5).grid(row=7, column = 1, pady =15,padx =2, sticky = 'nsew')      
            Button(self.stud_form, text="Cancel", font="Segoe 11", relief=GROOVE, bd=0, command=self.cancel, fg="black", bg="gold",height = 1, width = 5).grid(row=7, column = 2, pady =15,padx =10 , sticky = 'nsew')  
            Button(self.stud_form, text="Delete", font="Segoe 11", relief=GROOVE, bd=0, command=self.delete, fg="black", bg="gold",height = 1, width = 5).grid(row=7, column = 0, pady =15,padx =10, sticky = 'nsew')  
        ...
        self.label = Label(self.stud_form, text = 'Student Information', fg= 'gold' , font =('Segoe 18'), bg = 'maroon').grid(row= 0, column = 1, columnspan = 5, pady = 30, sticky = 'nsw')
        ...
        self.gender_bar = Radiobutton(self.stud_form, text = 'Male', variable = self.gender_choice, value =1,font = 'Segoe 13', bg = 'maroon', fg = 'gold').grid(row=6, column =1, sticky = 'sw', pady = 13,columnspan = 2)
        self.gender_bar = Radiobutton(self.stud_form, text = 'Female', variable = self.gender_choice, value =2,font = 'Segoe 13', bg= 'maroon', fg = 'gold').grid(row=6, column =1, sticky = 'sE', pady =13,columnspan = 2)
    ...
    def add_course(self):
        self.course_tp = Toplevel()
        self.course_tp.geometry("480x200")
        self.course_tp.title("Add new course")
        self.course_tp.resizable(False, False)
        self.course_tp.configure(bg = "maroon")
        Label(self.course_tp, text = "Course ID:", font = 'Segoe 16', bg = "maroon", fg= "gold").grid(row = 0, column = 0, padx = 30, pady = 20, sticky = 'w')
        self.course_id_bar = Entry(self.course_tp, font="Segoe 16", fg="Gray", bg="white", bd=0, justify=RIGHT)
        self.course_id_bar.grid(row =0,  column = 1, pady = 15, padx = 15) 
        Label(self.course_tp, text = "Course name:", font = 'Segoe 16', bg = "maroon", fg= "gold").grid(row = 1, column = 0, padx = 30, pady = 20, sticky = 'w')
        self.course_name_bar = Entry(self.course_tp, font="Segoe 16", fg="Gray", bg="white", bd=0, justify=RIGHT)
        self.course_name_bar.grid(row =1 ,  column = 1, pady = 15, padx = 15) 
        Button(self.course_tp, text="Save", font="Segoe 11", relief=GROOVE, bd=0, command=self.save_course, fg="black", bg="gold",height = 1, width = 5).grid(row=2, column = 0, pady =7,padx =2, sticky = 'e')      
        Button(self.course_tp, text="Cancel", font="Segoe 11", relief=GROOVE, bd=0, command=self.clear_course, fg="black", bg="gold",height = 1, width = 5).grid(row=2, column = 1, pady =7,padx =10)      
