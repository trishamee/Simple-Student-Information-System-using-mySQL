...
class mainframe(Frame):
    ...
    #Options
        ...
        Button(self.btn_frame, text='Clear Search', font = "Segoe 13", relief = GROOVE, bd = 0, command = self.show, fg ='black', height= 1, bg= 'Gold').grid(row = 0, column = 3,pady =7,padx =7,sticky="W")
