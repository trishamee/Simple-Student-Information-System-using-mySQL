...
class mainframe(Frame):
    ...
    #Options
        ...
        Button(self.btn_frame, text='Manage Courses', font = "Segoe 13", relief = GROOVE, bd = 0, command = self.manage_course, fg ='black', height= 1, bg= 'Gold').grid(row = 0, column = 3,pady =7,padx =7,sticky="W")
    ...
    def manage_course(self):
        ...
        self.mngtp.configure(bg = "maroon")
        ...
        self.course_frame.config(background = 'maroon', highlightbackground = 'gold')


        Label( self.course_frame, text = "Course ID:", font = 'Segoe 17', bg = "maroon", fg= "gold").grid(row = 0, column = 0, padx = 10, pady = 20, sticky = 'w')
        ...
        Label( self.course_frame, text = "Course name:", font = 'Segoe 17', bg = "maroon", fg= "gold").grid(row = 1, column = 0, padx = 10, pady = 20, sticky = 'w')
        ...
        self.frame2.config(background = 'maroon', highlightbackground = 'gold')
        ...
        def buttons():
            ...
            Button(self.frame2, text="Save", font="Segoe 15", relief=GROOVE, bd=0, command=save_course, fg="black", bg="gold",height = 1, width = 7).grid(row=0, column = 0, pady =7,padx =15, sticky = 'e')      
            Button(self.frame2, text="Update", font="Segoe 15", relief=GROOVE, bd=0, command=update_course, fg="black", bg="gold",height = 1, width = 7).grid(row=0, column = 1, pady =7,padx =15, sticky = 'e')      
            Button(self.frame2, text="Cancel", font="Segoe 15", relief=GROOVE, bd=0, command=clear_course, fg="black", bg="gold",height = 1, width = 7).grid(row=0, column = 3, pady =7,padx =15, sticky = 'e')      
            Button(self.frame2, text="Delete", font="Segoe 15", relief=GROOVE, bd=0, command=delete_course, fg="black", bg="gold",height = 1, width = 7).grid(row=0, column = 2, pady =7,padx =15,sticky = 'e')      
